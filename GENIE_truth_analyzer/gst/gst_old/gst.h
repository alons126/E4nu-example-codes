...
// found on file: 12C_0961GeV_G18_10a_02_11a.root
//////////////////////////////////////////////////////////
...
gst::gst(TTree* tree) : fChain(0) {
    ...
    if (tree == 0) {
        TFile* f = (TFile*)gROOT->GetListOfFiles()->FindObject("12C_0961GeV_G18_10a_02_11a.root");
        if (!f || !f->IsOpen()) { f = new TFile("12C_0961GeV_G18_10a_02_11a.root"); }
